	 ...
	 static String sOk = "OK!", sErr = "ERROR";
	    ...
	    public static void testLista() {
	        ...
	        System.out.println("Vacia copia: \t\t\t\t\t--> " + l2.toString());
                ...
                System.out.println("---------------------------------------------------------------------------");
                System.out.println("---------------------------------------------------------------------------");
                System.out.println("TEST ELIMINAR APARICIONES");
                Lista lis = new Lista();
                lis.insertar(1, lis.longitud()+1);
                lis.insertar(1, lis.longitud()+1);
                lis.insertar(1, lis.longitud()+1);
                lis.insertar(0, lis.longitud()+1);
                lis.insertar(1, lis.longitud()+1);
                lis.insertar(0, lis.longitud()+1);
                lis.insertar(0, lis.longitud()+1);
                lis.insertar(0, lis.longitud()+1);
                ...
                lis.eliminarApariciones(1);
                System.out.println("Lista sin 1:");
                System.out.println(lis.toString());
                System.out.print("\n");
                System.out.println("---------------------------------------------------------------------------");
                System.out.println("---------------------------------------------------------------------------");
                ...
                lis.insertar(2, lis.longitud()+1);
                lis.insertar(7, lis.longitud()+1);
                lis.insertar(1, lis.longitud()+1);
                lis.insertar(3, lis.longitud()+1);
                lis.insertar(5, lis.longitud()+1);
                System.out.println("Lista:");
                System.out.println(lis.toString());
                System.out.println("Longitud: "+lis.longitud());
                lis.cambiarPosicion(3, 5);
                System.out.println("pos1=3 y pos2=5: ");
                System.out.println(lis.toString());
                lis.cambiarPosicion(4, 1);
                System.out.println("pos1=4 y pos2=1: ");
                System.out.println(lis.toString());
	    }
